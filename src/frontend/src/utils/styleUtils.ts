...
export const SIDEBAR_BUNDLES = [
  ...
  { display_name: "Google Sheets", name: "googlesheets", icon: "GoogleSheets", section: "Cloud Geometry" },
  ...
  { display_name: "Jira", name: "jira", icon: "Jira", section: "Cloud Geometry" },
  ...
  { display_name: "Notion", name: "Notion", icon: "Notion", section: "Cloud Geometry" },
  ...
  { display_name: "Salesforce", name: "salesforce", icon: "Salesforce", section: "Cloud Geometry" },
  { display_name: "SambaNova", name: "sambanova", icon: "SambaNova" },
  { display_name: "SAP", name: "sap", icon: "SAP", section: "Cloud Geometry" },
  ...
  { display_name: "ServiceNow", name: "servicenow", icon: "ServiceNow", section: "Cloud Geometry" },
  { display_name: "SharePoint", name: "sharepoint", icon: "SharePoint", section: "Cloud Geometry" },
  ...
  { display_name: "Workday", name: "workday", icon: "Workday", section: "Cloud Geometry" },
  {
